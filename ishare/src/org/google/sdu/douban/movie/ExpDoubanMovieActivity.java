...
import org.google.sdu.main.BookActivity;
...
public class ExpDoubanMovieActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		logout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				ExpDoubanMovieActivity.this.finish();
			}
		});
		findViews();
	...
	private OnClickListener ol = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (e == null || e.equalsIgnoreCase("")) {
				Toast.makeText(ExpDoubanMovieActivity.this, "--请输入搜索内容--",
				...
				try {
					...
					ImageLoadTask.map = new HashMap<Object, Bitmap>();
					buildList(url);
	...
	private void buildList(final String url) {
		t_ready = new Thread(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				ArrayList<Movie> list = xmlResolver(url);
				ad = new MovieAdapter(ExpDoubanMovieActivity.this, list);
	...
	private String getUrl(String start, String end, String tag, String q) {
		String url = "http://api.douban.com/movie/subjects?start-index="
	...
	private void findViews() {
		...
		list_m = (ListView) findViewById(R.id.list_movie);
	}
